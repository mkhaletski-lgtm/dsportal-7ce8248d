...
const singles: Single[] = [
  ...
  },
  {
    ...
    extendedDescription:
      "Кинематографичный dance-pop на 128 BPM, где клубная энергия встречается с балеарской свободой. Яркие синтезаторные линии, чёткий ритм и пульсирующий грув создают звук, который мгновенно переносит на побережье под звёздным небом.\n\nЭмоциональная подача и летняя атмосфера делают этот трек саундтреком для моментов, когда хочется просто отпустить городскую суету и поймать свой ритм.\n\nВключай, если сегодня чувствуешь: лето — это не сезон, а состояние души.",
    links: {
  ...
  },
  {
    ...
    extendedDescription:
      "Кинематографичный dance-pop на 124 BPM, где энергия ночного шоссе встречается с тихой силой внутреннего перерождения. Чёткий ритм, атмосферные синтезаторы и чистая гитара в пространстве реверберации создают звук, который звучит как первый глубокий вдох после долгого затишья.\n\nИскренняя подача и продуманная аранжировка ведут туда, где страхи остаются в прошлом, а впереди — только свет и движение.\n\nВключай, если сегодня чувствуешь: иногда самый честный шаг — это отпустить старое и выбрать себя.",
    links: {
